...
public class Math3d : MonoBehaviour {
    static Transform tempChild = null, tempParent = null;
    ...
    public static void Init() {
        ...
        tempChild.parent = tempParent; // set the parent
    }

    //increase or decrease the length of vector by size
    public static Vector3 AddVectorLength(Vector3 vector, float size) {
        float magnitude = Vector3.Magnitude(vector); // get the vector length
        magnitude += size; // change the length
        Vector3 vectorNormalized = Vector3.Normalize(vector); // normalize the vector then scale
    ...
    public static Vector3 SetVectorLength(Vector3 vector, float size) {
        ...
        return vectorNormalized *= size; // scale the vector
    }
    ...
    public static bool LineLineIntersection(out Vector3 intersection, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2) {
        ...
        // sqrMagnitude does x*x+y*y+z*z on the input vector.
