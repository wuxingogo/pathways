...
namespace UnityStandardAssets.ImageEffects {
    ...
    class GlobalFogAdvanced : PostEffectsBase {
...
//			RenderTexture.ReleaseTemporary (tmpBuffer);
            ...
            if (distanceFog && heightFog)
                if (AffectSkyBox && Advanced.UseScattering) pass = 3;
				else if (AffectSkyBox) pass = 6; // distance + height + skybox + scattering
				else if (Advanced.UseScattering) pass = 9; // distance + height + skybox
				else pass = 0;// distance + height + Scattering
			 else if (distanceFog)
                if (AffectSkyBox && Advanced.UseScattering) pass = 4;
				else if (AffectSkyBox) pass = 7; // distance + skybox + scattering
                else if (Advanced.UseScattering) pass = 10; // distance + skybox
				else pass = 1; // distance only
			 else
                if (AffectSkyBox && Advanced.UseScattering) pass = 5; // height + skybox + scattering
				else if(AffectSkyBox) pass = 8; // height + skybox
                else if (Advanced.UseScattering) pass = 11; // height + Scattering
				else pass = 2; // height only
